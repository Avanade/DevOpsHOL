...
**NOTE: MARCH 2019- These instructions are based on new Azure DevOps**
...
Open Remote Desktop in windows(type remote desktop in the search button ) and enter your user name and password. Verify you can able to open visual stdio 2017.
